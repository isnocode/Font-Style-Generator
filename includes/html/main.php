...
<div id="main">
   ...
   <?php if ( isset($set) ):?>
      ...
      <div id="character-sets">
         <div class="row container">
            <div class="col12">
               <h2>more Font Style Generator</h2>
               <p>here are some more Font Style Generator for you to try out.</p>
            </div>
            <?php foreach ( $website['more'] as $value ):?>
               <div class="col6">
                  <a href="<?php echo $website['sets'][$value]['url'];?>">
                     <span><?php echo $website['sets'][$value]['name'];?></span>
                     <p>convert your text into <?php echo $website['sets'][$value]['example'];?> text using our <?php echo $website['sets'][$value]['name'];?> Font Style Generator</p>
                  </a>
               </div>
            <?php endforeach;?>
         </div>
   ...
   <?php else:?>
      ...
      <div id="statistics">
         <div class="row container">
            <div class="col4">
               <span><b class="animate-number" data-number="<?php echo $website['stats']['sets'];?>" data-duration="2000">0</b> Font Style Generator</span>
               <p>we have <b><?php echo number_format($website['stats']['sets']);?></b> different Font Style Generator for you to choose from</p>
            </div>
            <div class="col4">
               <span><b class="animate-number" data-number="<?php echo $website['stats']['uses'];?>" data-duration="2000">0</b> times</span>
               <p>our Font Style Generator have been used <b><?php echo number_format($website['stats']['uses']);?></b> times and counting</p>
            </div>
            <div class="col4">
            ...
            <?php foreach ( $website['sets'] as $set ):?>
               <div class="col6">
                  <a href="<?php echo $set['url'];?>">
                     ...
                     <p>convert your text into <?php echo $set['example'];?> text using our <?php echo $set['name'];?> Font Style Generator</p>
                  </a>
               </div>
            <?php endforeach;?>
         </div>
